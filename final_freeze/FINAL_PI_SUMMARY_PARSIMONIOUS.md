...
P15 在 eICU 外部验证中的 AUROC/AUPRC/calibration slope 为 0.8103/0.1892/1.0031，MT3 为 0.8090/0.1863/0.9652。P15 的 AUPRC 相对 MT3 变化为 +0.0029（+1.54%），没有出现性能损失，并且校准斜率更接近 1。
...
按 eICU external AUPRC，P15 没有损失，反而略高 1.54%；AUROC 也从 MT3 的 0.8090 到 P15 的 0.8103，基本持平。
